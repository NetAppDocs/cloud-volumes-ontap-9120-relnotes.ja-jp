...
* link:media/notice-aws.pdf["AWSのCloud Volumes ONTAP 9.12.0メディエーターに関する注意事項"^]
* link:media/notice-google-cloud.pdf["Google CloudのCloud Volumes ONTAP 9.12.0メディエーターに関するお知らせ"^]
